...
void add_TC_SYNC_DeRandomizeFrame_tests(void)
{
    ADD_TEST(Test_TC_SYNC_DeRandomizeFrame, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
}

void add_TC_SYNC_GetTransferFrame_tests(void)
{
    ADD_TEST(Test_TC_SYNC_GetTransferFrame_NullPtr, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
    ADD_TEST(Test_TC_SYNC_GetTransferFrame_BadCltu, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
    ADD_TEST(Test_TC_SYNC_GetTransferFrame_BadLength, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
    ADD_TEST(Test_TC_SYNC_GetTransferFrame, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
    ADD_TEST(Test_TC_SYNC_GetTransferFrame_DeRandom, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
}

void add_TC_SYNC_CheckStartSeq_tests(void)
{
    ADD_TEST(Test_TC_SYNC_CheckStartSeq_NullPtr, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
}

void add_TC_SYNC_GetCodeBlockData_tests(void)
{
    ADD_TEST(Test_TC_SYNC_GetCodeBlockData_NullPtr, TC_SYNC_Test_Setup, TC_SYNC_Test_TearDown);
}
