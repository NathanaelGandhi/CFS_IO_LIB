...
// extern TM_SDLP_FrameInfo_t     frameInfo;
// extern TM_SDLP_GlobalConfig_t  globConfig;
// extern TM_SDLP_ChannelConfig_t chnlConfig;
// // extern CFE_SB_Msg_t           *idlePacket;
// extern uint8 mcFrameCnt;
...
void Test_TM_SDLP_InitChannel_SecHdr_BadLen(void)
{
    ...
    // actual = TM_SDLP_InitChannel(&frameInfo, tframe, overflowBuff, &globConfig, &chnlConfig);
    // UtAssert_True(actual == expected, "return value == expected");
...
void Test_TM_SDLP_AddIdlePacket_BadMid(void)
{
    ...
    // globConfig.frameLength  = 100;
    // chnlConfig.overflowSize = 10;
    // TM_SDLP_InitChannel(&frameInfo, tframe, overflowBuff, &globConfig, &chnlConfig);
    // frameInfo.isReady = TRUE;
...
void Test_TM_SDLP_CompleteFrame(void)
{
    ...
    // actual = TM_SDLP_CompleteFrame(&frameInfo, &mcFrameCnt, NULL);
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(frameInfo.freeOctets == 94 && frameInfo.isReady == FALSE, "Frame Meta reset.");
}
...
void Test_TM_SDLP_NominalTest(void)
{
    ...
    // expected = 80;
    // UtAssert_True(frameInfo.overflowInfo.freeOctets == expected, "Overflow Buffer data size check.");
    ...
    // expected = 80;
    // UtAssert_True(frameInfo.overflowInfo.freeOctets == expected, "Empty Overflow Buffer check.");
    ...
    // UtAssert_True(frameInfo.overflowInfo.freeOctets == expected, "Overflow Buffer data size check.");
    // expected = 3;
    // UtAssert_True(frameInfo.overflowInfo.partialOctets == expected, "Overflow Buffer data size check.");
    ...
    // UtAssert_True(actual == expected, "Add large packet");
    // expected = 0;
    // UtAssert_True(frameInfo.overflowInfo.freeOctets == expected, "Overflow Buffer Full check.");
...
/* TM_SDLP_InitIdlePacket */
void add_TM_SDLP_InitIdlePacket_tests(void)
{
...
/* TM_SDLP_InitChannel */
void add_TM_SDLP_InitChannel_tests(void)
{
...
/* TM_SDLP_FrameHasData */
void add_TM_SDLP_FrameHasData_tests(void)
{
...
/* TM_SDLP_AddPacket */
void add_TM_SDLP_AddPacket_tests(void)
{
...
/* TM_SDLP_AddIdlePacket */
void add_TM_SDLP_AddIdlePacket_tests(void)
{
...
/* TM_SDLP_AddVcaData */
void add_TM_SDLP_AddVcaData_tests(void)
{
...
/* TM_SDLP_StartFrame */
void add_TM_SDLP_StartFrame_tests(void)
{
...
/* TM_SDLP_SetOidFrame */
void add_TM_SDLP_SetOidFrame_tests(void)
{
...
/* TM_SDLP_CompleteFrame */
void add_TM_SDLP_CompleteFrame_tests(void)
{
...
/* TM_SDLP_NominalTest */
void add_TM_SDLP_NominalTest_tests(void)
{
