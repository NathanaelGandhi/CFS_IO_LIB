...
void Test_TMTF_SetFirstHdrPtr_NoFirstHdrPtr(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(((testFramePtr->DataFieldStatus[0] * 256 + testFramePtr->DataFieldStatus[1]) == noFirstHdrPtrVal),
    //               "first hdr ptr == expected");
}
...
void Test_TMTF_SetFirstHdrPtr_OidOnly(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(((testFramePtr->DataFieldStatus[0] * 256 + testFramePtr->DataFieldStatus[1]) == oidFirstHdrPtrVal),
    //               "first hdr ptr == expected");
}
...
void Test_TMTF_SetFirstHdrPtr_Misc(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(((testFramePtr->DataFieldStatus[0] * 256 + testFramePtr->DataFieldStatus[1]) == 1),
    //               "first hdr ptr == expected");
}
...
void Test_TMTF_SetSecHdrLength_SecHdrFlagFalse(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(*((uint8 *)testFramePtr + TMTF_PRIHDR_SIZE) == 0x00, "sec hdr length == expected");
}
...
void Test_TMTF_SetSecHdrLength_Zero(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(*((uint8 *)testFramePtr + TMTF_PRIHDR_SIZE) == 0x3F, "sec hdr length == expected");
}
...
void Test_TMTF_SetSecHdrLength_Min(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(*((uint8 *)testFramePtr + TMTF_PRIHDR_SIZE) == 0x01, "sec hdr length == expected");
}
...
void Test_TMTF_SetSecHdrLength_Misc(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True(*((uint8 *)testFramePtr + TMTF_PRIHDR_SIZE) == 42, "sec hdr length == expected");
}
...
void Test_TMTF_UpdateErrCtrlField(void)
{
    ...
    // /* Verify results */
    // UtAssert_True(actual == expected, "return value == expected");
    // UtAssert_True((crcFrame[9] == 0xE5) && (crcFrame[10] == 0xCC), "CRC == expected");
}

/* ------------------- End of test cases --------------------------------------*/

#define ADD_TEST(test) UtTest_Add((test), TMTF_Test_Setup, TMTF_Test_TearDown, #test)

/* TMTF_SetVersion Tests */
void add_TMTF_SetVersion_tests(void)
{
...
/* TMTF_SetScId Tests */
void add_TMTF_SetScId_tests(void)
{
...
void add_TMTF_GetMcId_tests(void)
{
    ADD_TEST(Test_TMTF_GetMcId);
}

/* TMTF_SetVcId Tests */
void add_TMTF_SetVcId_tests(void)
{
...
void add_TMTF_GetGlobalVcId_tests(void)
{
    ADD_TEST(Test_TMTF_GetGlobalVcId);
}

/* TMTF_SetMcFrameCount Tests */
void add_TMTF_SetMcFrameCount_tests(void)
{
...
/* TMTF_SetVcFrameCount Tests */
void add_TMTF_SetVcFrameCount_tests(void)
{
...
/* TMTF_IncrVcFrameCount Tests */
void add_TMTF_IncrVcFrameCount_tests(void)
{
...
/* TMTF_SetOcfFlag Tests */
void add_TMTF_SetOcfFlag_tests(void)
{
...
/* TMTF_SetSecHdrFlag Tests */
void add_TMTF_SetSecHdrFlag_tests(void)
{
...
/* TMTF_SetSyncFlag Tests */
void add_TMTF_SetSyncFlag_tests(void)
{
...
/* TMTF_SetPacketOrderFlag Tests */
void add_TMTF_SetPacketOrderFlag_tests(void)
{
...
/* TMTF_SetSegLengthId Tests */
void add_TMTF_SetSegLengthId_tests(void)
{
...
/* TMTF_SetFirstHdrPtr Tests */
void add_TMTF_SetFirstHdrPtr_tests(void)
{
...
/* TMTF_SetSecHdrLength Tests */
void add_TMTF_SetSecHdrLength_tests(void)
{
...
/* TMTF_SetSecHdrData Tests */
void add_TMTF_SetSecHdrData_tests(void)
{
...
/* TMTF_SetOcf Tests */
void add_TMTF_SetOcf_tests(void)
{
...
void add_TMTF_UpdateErrCtrlField_tests(void)
{
