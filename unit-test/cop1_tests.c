...
/* COP1_InitClcw Tests */
void add_COP1_InitClcw_tests(void)
{
    ADD_TEST(Test_COP1_InitClcw, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_InitClcw_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwCtrlWordType Tests */
void add_COP1_GetClcwCtrlWordType_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwCtrlWordType_On, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwCtrlWordType_Off, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwCtrlWordType_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwVersion Tests */
void add_COP1_GetClcwVersion_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwVersion_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwVersion_NonZero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwVersion_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_SetClcwStatus Tests */
void add_COP1_SetClcwStatus_tests(void)
{
    ADD_TEST(Test_COP1_SetClcwStatus_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwStatus_NonZero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwStatus_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwStatus Tests */
void add_COP1_GetClcwStatus_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwStatus_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwStatus_NonZero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwStatus_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwCopEffect Tests */
void add_COP1_GetClcwCopEffect_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwCopEffect_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwCopEffect_Max, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwCopEffect_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwVcId Tests */
void add_COP1_GetClcwVcId_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwVcId_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwVcId_Max, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwVcId_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_SetClcwNoRf Tests */
void add_COP1_SetClcwNoRf_tests(void)
{
    ADD_TEST(Test_COP1_SetClcwNoRf_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwNoRf_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwNoRf_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwNoRf Tests */
void add_COP1_GetClcNoRf_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwNoRf_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwNoRf_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwNoRf_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_SetClcwNoBitlock Tests */
void add_COP1_SetClcwNoBitlock_tests(void)
{
    ADD_TEST(Test_COP1_SetClcwNoBitlock_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwNoBitlock_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_SetClcwNoBitlock_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwNoBitlock Tests */
void add_COP1_GetClcwNoBitlock_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwNoBitlock_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwNoBitlock_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwNoBitlock_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwLockout Tests */
void add_COP1_GetClcwLockout_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwLockout_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwLockout_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwLockout_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwWait Tests */
void add_COP1_GetClcwWait_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwWait_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwWait_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwWait_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwRetransmit Tests */
void add_COP1_GetClcwRetransmit_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwRetransmit_False, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwRetransmit_True, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwRetransmit_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwFarmbCtr Tests */
void add_COP1_GetClcwFarmbCtr_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwFarmbCtr_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwFarmbCtr_Max, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwFarmbCtr_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_GetClcwReport Tests */
void add_COP1_GetClcwReport_tests(void)
{
    ADD_TEST(Test_COP1_GetClcwReport_Zero, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwReport_Max, COP1_Test_Setup, COP1_TearDown);
    ADD_TEST(Test_COP1_GetClcwReport_NullPtr, COP1_Test_Setup, COP1_TearDown);
}

/* COP1_ProcessFrame Tests */
void add_COP1_ProcessFrame_tests(void)
{
    ADD_TEST(Test_COP1_ProcessFrame_NullTf, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_ProcessFrame_NullClcw, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_ProcessFrame_InvalidTf, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
}

/* COP1_BypassTf Tests */
void add_COP1_BypassTf_tests(void)
{
    ADD_TEST(Test_COP1_BypassTf_DataFrm, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_BypassTf_Unlock, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_BypassTf_SetVr_Locked, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_BypassTf_SetVr_Unlocked, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_BypassTf_SetVr_MalformedCmd, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_BypassTf_UnknownCmd, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
}

/* COP1_AcceptTf Tests */
void add_COP1_AcceptTf_tests(void)
{
    ADD_TEST(Test_COP1_AcceptTf_Locked, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_GoodSeqNoBuf, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_GoodSeqGoodBuf, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_PosSeqWindow, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_PosSeqWindowLim, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_NegSeqWindow, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_NegSeqWindowLim, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_LockoutPos, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
    ADD_TEST(Test_COP1_AcceptTf_LockoutNeg, COP1_Test_Setup_ProcessFrame, COP1_TearDown);
}
